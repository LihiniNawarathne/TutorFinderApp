...
public class admin_add_chatgroup_arts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_add_chatgroup_arts);

        recyclerView = findViewById(R.id.rvarts);
        ...
        root.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot dataSnapshot : snapshot.getChildren()) {
                    ...
                    if (studentPay.getAlstream().equals("Art")) {
                        stupaymentList.add(studentPay);
                        adapter = new studentpaymentAdapter(stupaymentList, admin_add_chatgroup_arts.this);
