...
public class admin_add_chatgroup_commerce extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_add_chatgroup_commerce);

        recyclerView = findViewById(R.id.rvcommerce);
        ...
        root.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot dataSnapshot : snapshot.getChildren()) {
                    ...
                    if (studentPay.getAlstream().equals("commerce")) {
                        stupaymentList.add(studentPay);
                        adapter = new studentpaymentAdapter(stupaymentList, admin_add_chatgroup_commerce.this);
